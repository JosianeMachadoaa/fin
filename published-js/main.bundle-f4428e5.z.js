!(function (n) {
  ...
  function (e, t, n) {
    ...
    function g(e) {
      ...
      return (
        ...
        delete t["cf-turnstile-response"],
        delete t["cf-error-code"],
        Object.keys(t)
          .filter(function (e) {
            return /^ubafs-/.test(e);
          })
        ...
        case h.FormAction.PostToUrl:
          !o.url && f.pageIsEmbeddable()
            ...
            : ((r =
              ...
              (0, y.default)('input[name^="cf-turnstile-response"]', e).forEach(
                function (e) {
                  return e.parentNode && e.parentNode.removeChild(e);
                }
              ),
              (0, y.default)('input[name^="cf-error-code"]', e).forEach(
                function (e) {
                  return e.parentNode && e.parentNode.removeChild(e);
                }
              ),
  ...
  function (e, t, n) {
    ...
    function u(o) {
      (0, i.default)(".lp-pom-image img").forEach(function (e) {
        var t, n, r;
        (e.src = a(e, o, 1)),
          (e.srcset =
            ((n = a((e = e), (t = o), 1)),
            (r = a(e, t, 2)),
            (e = a(e, t, 3))
              ? "".concat(n, " 1x, ").concat(r, " 2x, ").concat(e, " 3x")
              : r
              ? "".concat(n, " 1x, ").concat(r, " 2x")
              : ""));
      });
    }
    t.default = function () {
      u((0, o.getCurrentBreakpoint)()), (0, o.onBreakpointChange)(u);
    };
  },
  function (e, t, n) {
    "use strict";
    ...
    t.r(oe),
      function (e, b) {
        ...
        H ||
          ...
          (T = {
            fullscreenchange: P.fullscreenchange,
            fullscreenerror: P.fullscreenerror,
          }),
          (S = {
            request: function (o) {
              ...
              return new Promise(function (t, e) {
                ...
                S.isFullscreen
                  ? (S.on(
                    ...
                    (r = document[P.exitFullscreen]()) instanceof Promise &&
                      r.then(n).catch(e))
                  : t();
              });
            },
          ...
          Object.defineProperties(S, {
            isFullscreen: {
              get: function () {
                return Boolean(document[P.fullscreenElement]);
              },
            },
            element: {
              enumerable: !0,
              get: function () {
                return document[P.fullscreenElement];
              },
            },
            isEnabled: {
              enumerable: !0,
              get: function () {
                return Boolean(document[P.fullscreenEnabled]);
              },
            },
          }),
          (L = S),
